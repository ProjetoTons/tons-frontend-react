...
function TopNavBar({ onNavClick, currentPage = "pedidos" }) {
  ...
  return (
    <nav aria-label="Navegação principal" className="bg-[#fcfcfc] border-b border-[#e4e2e2] px-4 lg:px-6 py-2 flex items-center justify-between gap-4 sticky top-0 z-50 h-[52px] lg:h-[60px] flex-shrink-0">
